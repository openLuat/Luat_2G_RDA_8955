...
--- 闪烁指示灯
-- @param ledPin,ledPin(1)用pins.setup注册返回的方法
-- @param light, light-亮灯时间ms
-- @param dark, dark-灭灯时间ms
-- @return null
...
-- @param bl,亮灯时间ms
-- @param bd,灭灯时间ms
-- @param cnt,重复次数 (等级的级别,亮灭1次算数字1)
-- @param gap,间隔时间 (每次循环周期的间隔)
-- @return 无
...
--- 呼吸灯
-- @param ledPin, 呼吸灯的ledPin(1)用pins.setup注册返回的方法
-- @return 无
